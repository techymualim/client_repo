        ...
        <>
            ...
            <section className='container container-custom flex flex-col min-h-[0] py-10 md:py-16 md:pt-8 mt-24'>
                <div className="mx-auto px-6 md:px-24 text-white">
                    ...
                    <Subtitle blue text={'Effective Date: July 23rd 2023'} />
                    ...
                    <Paragraph text={'Innox is a marketplace that enables creators to create ERC-20 tokens and mint them for sale to their fans ("Buyers"). Users can mint and swap these tokens using the Uniswap interface, subject to the terms and conditions set forth herein. Tokens can be used by fans to access exclusive offerings by their creators: content, giveaways and merchandise.'} />
                    ...
                    <Paragraph text={'On Innox, creators have the opportunity to tokenize their digital content, creative works, or services as ERC-20 tokens. Tokenization i in this context refers to the process of using tokens to access exclusive offerings by creators.'} />
                    ...
                    <Paragraph text={'To ensure transparency and security, creator tokens are governed by smart contracts deployed on the Ethereum blockchain. These smart contracts dictate token behavior, issuance rules, and any predefined functionalities, ensuring that token transactions occur as intended by the creator.'} />
